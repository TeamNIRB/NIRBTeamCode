...
public class BeastDrive extends LinearOpMode
{
    ...
    int clawPositionStatusStart = 0; // 0=grab 1=rotate 2=finish rotate 3=drive
    ...
    public void claw()
    {
        ...
        if((clawPositionStatus == 0 || clawPositionStatus == 3) & armButtonY)
        {
            clawPositionStatusStart = clawPositionStatus;
        ...
        else if(clawPositionStatus == 2 & System.currentTimeMillis() >= (timeStart + 200))
        {
            ...
            clawPositionStatus = clawPositionStatusStart;
    ...
    public void telemetry1()
    {
        ...
        telemetry.addData("SlideLefttarget", motorSlideLeftPos);
        telemetry.addData("SlideRighttarget", motorSlideRightPos);
